...
async def find_nearby(lat: float, lon: float, categorie: str, top_n: int = 10) -> list[dict]:
    """
    Interroge Overpass pour une catégorie donnée autour d'un point,
    calcule la distance réelle pour chaque résultat et retourne les
    top_n plus proches, triés par distance croissante.
    """
